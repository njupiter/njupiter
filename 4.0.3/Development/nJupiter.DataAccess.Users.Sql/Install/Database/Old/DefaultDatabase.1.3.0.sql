...
GO
 ...
 CREATE  INDEX [IX_USER_ContextualPropertySchema_ContextID] ON [dbo].[USER_ContextualPropertySchema]([ContextID]) ON [PRIMARY]
GO

 CREATE  INDEX [IX_USER_ContextualPropertySchema_PropertyID] ON [dbo].[USER_ContextualPropertySchema]([PropertyID]) ON [PRIMARY]
GO

 CREATE  UNIQUE  INDEX [IX_USER_Property_UniqueID_unique] ON [dbo].[USER_Property]([UniqueID]) ON [PRIMARY]
GO
...
-- Do not use id 0. ContextID 0 is reserved for the default context
